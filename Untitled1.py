 ...
 "cells": [
  {
   "cell_type": "code",
   "execution_count": 1,
   "id": "05835157-4098-4c78-b456-b75a2c320126",
   "metadata": {},
   "outputs": [
    {
     "data": {
      "application/vnd.jupyter.widget-view+json": {
       "model_id": "f19d76d535784952b191bd1b95bb9d51",
       "version_major": 2,
       "version_minor": 0
      },
      "text/plain": [
       "VBox(children=(HBox(children=(Button(button_style='warning', description='Switch to Complex Input', style=Butt…"
      ]
     },
     "metadata": {},
   ...
   "source": [
    ...
    "\n",
    "def Bloch_sphere(theta1, phi1, theta2, phi2, show_history=True):\n",
    ...
    "    \"H\": hadamard_gate}\n",
    "\n",
    "def full_spin(U): #this function makes the pauli gates do full circles as they only did 180 degrees both ways before\n",
    "    det = np.linalg.det(U)\n",
    "    U = U / np.sqrt(det)\n",
    "    trace = np.trace(U)\n",
    ...
    "    raw = circuit_input.value.strip()\n",
    "    if not raw:\n",
    "        circuit_status.value = \"⚠ Enter at least one gate.\"\n",
    "        return\n",
    "    gate_names = [g.strip() for g in raw.split(\",\")]\n",
    "    unknown = [g for g in gate_names if g not in circuit_inputs]\n",
    "    if unknown:\n",
    "        circuit_status.value = f\"⚠ Unknown gate(s): {', '.join(unknown)}\"\n",
    "        return\n",
    ...
    "    output,\n",
    "    widgets.HTML(\"<b>Measurement Probabilities</b>\") ,\n",
    "    prob_output\n",
    "]))"
   ]
  },
  {
   ...
   "id": "b895f4fb-3559-4931-aba0-1b641877d65a",
   "metadata": {},
   "outputs": [],
   "source": []
  }
